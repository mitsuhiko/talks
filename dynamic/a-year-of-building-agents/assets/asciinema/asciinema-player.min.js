var AsciinemaPlayer = (function (A) {
    ...
    return "number" == typeof A
      ...
      : "string" == typeof A
        ? A.split(":")
            .reverse()
            .map(parseFloat)
            .reduce((A, B, Q) => A + B * Math.pow(60, Q))
        : void 0;
  }
  class Q {
    log() {}
  ...
  class g {
    ...
    log(A) {
      for (var B = arguments.length, Q = new Array(B > 1 ? B - 1 : 0), g = 1; g < B; g++)
        Q[g - 1] = arguments[g];
  ...
  let t = 0,
    C = null;
  function i() {
    return ((null !== C && 0 !== C.byteLength) || (C = new Uint8Array(E.memory.buffer)), C);
  }
  const o =
  ...
  function r(A, B, Q) {
    ...
    if (I !== g) {
      (0 !== I && (A = A.slice(I)), (E = Q(E, g, (g = I + 3 * A.length), 1) >>> 0));
  ...
  let s = null;
  function a() {
    return ((null !== s && 0 !== s.byteLength) || (s = new Int32Array(E.memory.buffer)), s);
  }
  let c = V.length;
  function l(A) {
  ...
  function d(A, B) {
    return (
      (A >>>= 0),
      ((null !== D && 0 !== D.byteLength) || (D = new Uint32Array(E.memory.buffer)), D).subarray(
        A / 4,
        A / 4 + B,
      )
    );
  ...
  function q() {
    ...
    return (
      (A.wbg.__wbindgen_is_string = function (A) {
        return "string" == typeof I(A);
      }),
      (A.wbg.__wbg_new_b525de17f44a8943 = function () {
        return l(new Array());
      }),
      (A.wbg.__wbg_set_17224bc548dd1d7b = function (A, B, Q) {
        I(A)[B >>> 0] = w(Q);
      }),
      (A.wbg.__wbindgen_debug_string = function (A, B) {
      ...
      (A.wbg.__wbindgen_bigint_from_u64 = function (A) {
        return l(BigInt.asUintN(64, A));
      }),
      (A.wbg.__wbindgen_error_new = function (A, B) {
        return l(new Error(u(A, B)));
      }),
      (A.wbg.__wbg_new_f9876326328f45ed = function () {
        return l(new Object());
      }),
      (A.wbg.__wbg_set_f975102236d3c502 = function (A, B, Q) {
        I(A)[w(B)] = w(Q);
      }),
      (A.wbg.__wbg_new_f841cc6f2098f4b5 = function () {
        return l(new Map());
      }),
      (A.wbg.__wbg_set_388c4c6422704173 = function (A, B, Q) {
        return l(I(A).set(I(B), I(Q)));
      }),
      (A.wbg.__wbindgen_object_drop_ref = function (A) {
        w(A);
      }),
      (A.wbg.__wbindgen_string_new = function (A, B) {
        return l(u(A, B));
      }),
      (A.wbg.__wbindgen_object_clone_ref = function (A) {
        return l(I(A));
      }),
      (A.wbg.__wbindgen_throw = function (A, B) {
  ...
  function k(A, B) {
    return ((E = A.exports), (p.__wbindgen_wasm_module = B), (s = null), (D = null), (C = null), E);
  }
  async function p(A) {
    ...
    ("string" == typeof A ||
      ...
      (A = fetch(A));
    const { instance: Q, module: g } = await (async function (A, B) {
  ...
  class m {
    constructor(A, B) {
      ((this.input = "function" == typeof A.next ? A : A[Symbol.iterator]()), (this.xfs = B ?? []));
    }
    map(A) {
  ...
  function K(A) {
    ...
    const B = /^#[0-9A-Fa-f]{6}$/,
      ...
      g = A?.bg,
      E = A?.palette;
    return B.test(Q) && B.test(g) && /^(#[0-9A-Fa-f]{6}:){7,}#[0-9A-Fa-f]{6}$/.test(E)
  ...
  function T() {
    let A = 0;
    return function (B) {
      return "m" === B[1] ? [B[0], B[1], { index: A++, time: B[0], label: B[2] }] : B;
    };
  }
  class H {
    constructor() {
  ...
  function O(A, B, Q, g, E, V, I, e, t) {
    const C = (function (A, B, Q, g) {
      return function (E, V) {
        "o" === E ? A(V) : "i" === E ? Q(V) : "r" === E ? B(V.cols, V.rows) : "m" === E && g(V);
      };
    })(B, Q, g, E);
    if (0 === A)
      return (
      ...
      );
    {
      ...
      return (
        "number" == typeof (A = A ?? {})
          ? (t.debug(`using fixed time buffer (${A} ms)`), (B = (B) => A))
          : "function" == typeof A
              ...
              (B = (function () {
                ...
                return function (f) {
                  ...
                  if (((c = y), null === l)) l = f;
                    ...
                    const A = 1 - Math.pow(2, -q / V);
                    l += A * (f - l);
                  } else {
                    const A = 1 - Math.pow(2, -q / I);
                    l += A * (f - l);
                  }
                  if (((l = Math.max(l, 0)), null === h)) h = f;
                  else if (f > h) {
                    const A = 1 - Math.pow(2, -q / e);
                    h += A * (f - h);
                  } else {
                    const A = 1 - Math.pow(2, -q / t);
                    h += A * (f - h);
                  }
                  h = Math.max(h, 0);
                  const k = o * (l + (l - h));
                  ...
                  return (
                    ...
                    f > a && A.debug("buffer underrun", { latency: f, bufferTime: a }),
                    p > s
                    ...
                    null !== D &&
                      ((a += d * q),
                      ((d >= 0 && a > D) || (d < 0 && a < D)) && ((a = D), (D = null))),
                    a
                  );
                };
              })({ logger: t }, A))),
        (function (A, B, Q, g, E) {
          let V = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 1 / 60,
          ...
          return (
            ...
            }, 0),
            {
              pushEvent(B) {
                let Q = o() - 1e3 * B[0];
                (Q < 0 && (g.debug(`correcting epoch by ${Q} ms`), (I += Q), (Q = 0)),
                  (e = A(Q)),
                  t.push(B));
              },
              pushText(A) {
  ...
  class P {
    constructor(A) {
      let B = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
    ...
    decodeVarUint() {
      let A = BigInt(0),
        ...
        Q = this.getUint8();
      for (; Q > 127; )
        ((Q &= 127), (A += BigInt(Q) << B), (B += BigInt(7)), (Q = this.getUint8()));
  ...
  function $() {
    ...
    let B = function (g) {
      ...
      return ((B = Q), { time: 0, term: { size: { cols: V, rows: I }, init: E } });
    };
    function Q(B) {
  ...
  function AA(A) {
    const B = Math.min(500 * Math.pow(2, A), 1e4);
  ...
  class EA {
    ...
    unmute() {
      this.driver && this.driver.unmute() && this.core._dispatchEvent("muted", !1);
    }
    seek(A) {
      return !1;
    }
  ...
  class IA extends EA {
    ...
    async doPlay() {
      ...
      !0 === A
        ...
        : "function" == typeof A && (this.core._setState("playing"), (this.driver.stop = A));
    }
    async togglePlay() {
      await this.play();
    }
  ...
  class eA extends EA {
    ...
    pause() {
      !0 === this.driver.pause() && this.core._setState("idle", { reason: "paused" });
    }
    togglePlay() {
      this.pause();
    }
  ...
  class iA extends EA {
    ...
    async seek(A) {
      return !0 === (await this.driver.seek(A)) && (this.core._setState("idle"), !0);
    }
  }
  class oA extends EA {
    onEnter() {
  ...
  class nA {
    ...
    async init() {
      ...
      const V = "text" === this.poster.type ? this._renderPoster(this.poster.value) : null,
        I = { isPausable: !!this.driver.pause, isSeekable: !!this.driver.seek, poster: V };
      if (
    ...
    _doFeed(A) {
      (this.vt.feed(A).forEach((A) => this.changedLines.add(A)), (this.cursor = void 0));
    }
    async _initializeDriver() {
      ...
      ((this.cols = this.cols ?? A.cols ?? 80),
        ...
        (this.markers = this._normalizeMarkers(A.markers) ?? this.markers ?? []),
    ...
    _resetVt(A, B) {
      let Q = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : void 0,
        g = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : void 0;
  ...
  const rA = new Map([
        ...
        function (A, B) {
          ...
          return {
            async init() {
              ...
              for (const [A, B] of Q) e += new Blob([B]).size;
              return { cols: B, rows: E, duration: I };
            },
            play() {
              const A = performance.now();
              for (let A = 0; A < E; A++) {
                for (const [A, B] of Q) V(B);
                V("c");
              }
      ...
      [
        "clock",
        function (A, B, Q) {
          let { hourColor: g = 3, minuteColor: E = 4, separatorColor: V = 9 } = A,
            { feed: I } = B,
            { cols: e = 5, rows: t = 1 } = Q;
      ...
      [
        ...
        function (A, B) {
          let Q,
            ...
            { feed: t, reset: C, resize: i, onInput: o, onMarker: n, setState: r, logger: s } = B;
          s = new g(s, "eventsource: ");
          let a = new L();
          function c(A) {
            (void 0 !== E && E.stop(), (E = O(I, t, i, o, n, (A) => a.setTime(A), A, e, s)));
          }
          return {
            play: () => {
              ((Q = new EventSource(V)),
                ...
                Q.addEventListener("done", () => {
                  (s.info("closed"), Q.close(), r("ended", { message: "Stream ended" }));
                }));
            },
            stop: () => {
      ...
      [
        ...
        function (A, B, Q) {
          let g,
            ...
            r,
            s,
            { feed: a, resize: c, onInput: l, onMarker: h, setState: u, logger: w } = B,
            {
              speed: D,
              idleTimeLimit: d,
              startAt: f,
          ...
          async function b(A, B) {
            ...
            if (!Q.ok) throw `failed fetching recording from ${A}: ${Q.status} ${Q.statusText}`;
            return Q;
          }
          function Y() {
            const A = V[M];
          ...
          function W() {
            (H(),
              ...
              !0 === y || ("number" == typeof y && L < y)
                ? ((M = 0), (i = v()), a("c"), _(), Y(), s && (s.currentTime = 0))
                : ((o = 1e3 * e), u("ended"), s && s.pause()));
          }
          function Z() {
            return ((S = !1), s && s.pause(), !C || (H(), (o = v() - i), !0));
          }
          async function j() {
            (s &&
              !r &&
          ...
          async function z(A) {
            ...
            if ("string" == typeof A)
              ...
              if ("prev" === A.marker) ((A = X(Q) ?? 0), B && Q - A < 1 && (A = X(A) ?? 0));
          ...
          function P() {
            ...
            const { contextTime: A, performanceTime: B } = r.getOutputTimestamp();
          ...
          function AA() {
            (w.debug("audio resumed"),
              ...
              J &&
                ((J = !1),
                S && (w.debug("resuming session playback"), (i = v() - o), (o = null), Y())));
          }
          return {
            init: async function () {
              const B = setTimeout(() => {
              ...
              try {
                let B = (async function (A, B, Q) {
                  const {
                    ...
                    s = await (async function (A) {
                      let { url: B, data: Q, fetchOpts: g = {} } = A;
                      if ("string" == typeof B) return await b(B, g);
                      if (Array.isArray(B)) return await Promise.all(B.map((A) => b(A, g)));
                      if (void 0 !== Q) {
                    ...
                    a = (function (A, B, Q) {
                          ...
                          (function (A) {
                            ...
                            return (g) => {
                              ...
                              return {
                                ...
                                flush: () => {
                                  (void 0 !== B && (g(B), V++),
                                    A.debug(`batched ${E} frames to ${V} frames`));
                                },
                              };
                            };
                          })(B, V),
                      ...
                      ((t = t.toArray()),
                        void 0 !== I &&
                          ((t = t.map((A) => ("i" === A[1] ? [A[0] + I, A[1], A[2]] : A))),
                          t.sort((A, B) => A[0] - B[0])));
                      const i = t[t.length - 1][0],
                        o = g - C.offset;
                      return { ...A, events: t, duration: i, effectiveStartAt: o };
                    })(await C(s, { encoding: r }), B, { ...Q, minFrameTime: i, inputOffset: o });
                  if (
                    (({ cols: g, rows: E, events: V, duration: e, effectiveStartAt: t } = a),
                    (F = F ?? g),
                    (G = G ?? E),
                    0 === V.length)
                  )
                  ...
                  void 0 !== n &&
                    (function (A, B) {
                      const Q = document.createElement("a"),
                        g = A.events.map((A) => ("m" === A[1] ? [A[0], A[1], A[2].label] : A)),
                        E = (function (A) {
                          return `${JSON.stringify({ version: 2, width: A.cols, height: A.rows })}\n${A.events.map(JSON.stringify).join("\n")}\n`;
                        })({ ...A, events: g });
                      ((Q.href = URL.createObjectURL(new Blob([E], { type: "text/plain" }))),
                        (Q.download = B),
                        Q.click());
                    })(a, n);
                  const c =
                    void 0 !== q
                      ? ((l = q), V.filter((A) => A[0] < l && "o" === A[1]).map((A) => A[2]))
                      : void 0;
                  var l;
                  return (
                    (I = V.filter((A) => "m" === A[1]).map((A) => [A[0], A[2].label])),
                    { cols: g, rows: E, duration: e, theme: a.theme, poster: c, markers: I }
                  );
                ...
                const Q = await (async function (A) {
                  ...
                  ((s = await (async function (A) {
                    const B = new Audio();
                    let Q;
                    ((B.preload = "metadata"), (B.loop = !1), (B.crossOrigin = "anonymous"));
                    ...
                    return (B.addEventListener("canplay", E), (B.src = A), B.load(), await g, B);
                  })(A)),
                    (U =
                    ...
                    U
                      ? (s.addEventListener("playing", AA), s.addEventListener("waiting", $))
                      : w.warn(
      ...
      [
        ...
        function (A, B, Q) {
          let E,
            V,
            { url: I, bufferTime: e, reconnectDelay: t = AA, minFrameTime: C } = A,
            { feed: i, reset: o, resize: n, onInput: r, onMarker: s, setState: a, logger: c } = B,
            { audioUrl: l } = Q;
          c = new g(c, "websocket: ");
          let h,
            u,
            ...
            y = !1;
          function q() {
            ((E = new WebSocket(I, ["v1.alis", "v2.asciicast", "v3.asciicast", "raw"])),
                      ...
                      ? (E.onmessage = k(
                          (function () {
                            let A = function (Q) {
                              ...
                              if (2 !== g.version) throw "not an asciicast v2 stream";
                              return (
                                (A = B),
                                { time: 0, term: { size: { cols: g.width, rows: g.height } } }
                              );
                            };
                            function B(A) {
                              ...
                              if ("r" === B[1]) {
                                ...
                                return [
                                  B[0],
                                  "r",
                                  { cols: parseInt(A, 10), rows: parseInt(Q, 10) },
                                ];
                              }
                              return B;
                            }
                        ...
                        ? (E.onmessage = k(
                            (function () {
                              let A = function (B) {
                                  ...
                                  if (3 !== g.version) throw "not an asciicast v3 stream";
                                  A = Q;
                                  const E = { size: { cols: g.term.cols, rows: g.term.rows } };
                                  return (
                                    g.term.theme &&
                                      (E.theme = {
                                        foreground: g.term.theme.fg,
                                        background: g.term.theme.bg,
                                        palette: g.term.theme.palette.split(":"),
                                      }),
                                    { time: 0, term: E }
                                  );
                                },
                              ...
                              function Q(A) {
                                ...
                                if (((B += g), "r" === E)) {
                                  const [A, Q] = V.split("x");
                                  return [B, "r", { cols: parseInt(A, 10), rows: parseInt(Q, 10) }];
                                }
                                return [B, E, V];
                              }
                              return function (B) {
              ...
              (E.onclose = (A) => {
                if ((clearTimeout(u), G(), f || 1e3 === A.code || 1005 === A.code))
                  (c.info("closed"), a("ended", { message: "Stream ended" }));
                else if (1002 === A.code)
                  (c.debug(`close reason: ${A.reason}`),
                    a("ended", { message: "Err: Player not compatible with the server" }));
                else {
                  clearTimeout(h);
                  const A = t(d++);
                ...
                try {
                  ...
                  if (V)
                    if (Array.isArray(Q)) V.pushEvent(Q);
                      ...
                      if (!1 === Q) F();
                      else if (void 0 !== Q) throw `unexpected value from protocol handler: ${Q}`;
                    } else p(Q);
                  else if ("object" != typeof Q || Array.isArray(Q)) {
                    if (void 0 !== Q)
                      throw (clearTimeout(u), `unexpected value from protocol handler: ${Q}`);
          ...
          function F() {
            (G(),
              y
                ? (c.info("stream ended"), a("offline", { message: "Stream ended" }))
                : (c.info("stream offline"), a("offline", { message: "Stream offline" })),
              (D = new L()));
          }
          function G() {
            (V && V.stop(), (V = null));
          ...
          return {
            ...
            stop: () => {
              ((f = !0), G(), void 0 !== E && E.close(), w && w.pause());
            },
            mute: function () {
      ...
      [
        ...
        async function (A, B) {
          ...
          const e = await A[1].arrayBuffer(),
            t = new Uint8Array(e),
            C = t.findIndex((A) => 10 == A) + 1,
            i = g.decode(t.subarray(0, C)).match(/COLUMNS="(\d+)" LINES="(\d+)"/);
  ...
  function GA(A, B) {
    const Q = qA,
      ...
      E = 0 === A.length,
      V = void 0 === B ? g : B,
      I = E ? dA : { owned: null, cleanups: null, context: V ? V.context : null, owner: V },
      e = E ? A : () => A(() => mA(() => PA(I)));
    ((fA = I), (qA = null));
    try {
      return ZA(e, !0);
  ...
  function NA(A, B) {
    ...
    return [xA.bind(Q), (A) => ("function" == typeof A && (A = A(Q.value)), TA(Q, A))];
  }
  function MA(A, B, Q) {
    HA(OA(A, B, !1, wA));
  }
  ...
  function SA(A) {
    return (null === fA || (null === fA.cleanups ? (fA.cleanups = [A]) : fA.cleanups.push(A)), A);
  }
  function vA() {
    return qA;
  }
  ...
  function xA() {
    ...
    if (qA) {
      ...
      (qA.sources
        ...
        this.observers
          ? (this.observers.push(qA), this.observerSlots.push(qA.sources.length - 1))
          : ((this.observers = [qA]), (this.observerSlots = [qA.sources.length - 1])));
    }
    return this.value;
  }
  function TA(A, B, Q) {
  ...
  function HA(A) {
    ...
    !(function (A, B, Q) {
      ...
      try {
        ...
        return (
          A.pure && ((A.state = wA), A.owned && A.owned.forEach(PA), (A.owned = null)),
          (A.updatedAt = Q + 1),
          $A(B)
        );
      } finally {
      ...
      (!A.updatedAt || A.updatedAt <= Q) &&
        (null != A.updatedAt && "observers" in A ? TA(A, g) : (A.value = g), (A.updatedAt = Q));
    })(A, A.value, B);
  }
  function OA(A, B, Q, g = wA, E) {
    const V = {
      fn: A,
      state: g,
      updatedAt: null,
    ...
    return (null === fA || (fA !== dA && (fA.owned ? fA.owned.push(V) : (fA.owned = [V]))), V);
  }
  function WA(A) {
    if (0 === A.state) return;
    if (A.state === DA) return XA(A);
    if (A.suspense && mA(A.suspense.inFallback)) return A.suspense.effects.push(A);
    const B = [A];
    for (; (A = A.owner) && (!A.updatedAt || A.updatedAt < FA); ) A.state && B.push(A);
  ...
  function XA(A, B) {
    ...
    for (let Q = 0; Q < A.sources.length; Q += 1) {
      ...
      if (g.sources) {
        const A = g.state;
        A === wA ? g !== B && (!g.updatedAt || g.updatedAt < FA) && WA(g) : A === DA && XA(g, B);
      }
    }
  }
  function _A(A) {
    for (let B = 0; B < A.observers.length; B += 1) {
      const Q = A.observers[B];
      Q.state || ((Q.state = DA), Q.pure ? kA.push(Q) : pA.push(Q), Q.observers && _A(Q));
    }
  }
  function PA(A) {
    let B;
    if (A.sources)
      for (; A.sources.length; ) {
        ...
        if (g && g.length) {
          ...
          Q < g.length && ((A.sourceSlots[E] = Q), (g[Q] = A), (B.observerSlots[Q] = E));
        }
      }
    if (A.tOwned) {
          ...
          () => {
            ...
            return (
              ...
              mA(() => {
                ...
                if (0 === o)
                  (0 !== I && (QB(V), (V = []), (g = []), (E = []), (I = 0), e && (e = [])),
                    Q.fallback &&
                      ((g = [BB]), (E[0] = GA((A) => ((V[0] = A), Q.fallback()))), (I = 1)));
                else if (0 === I) {
                  for (E = new Array(o), C = 0; C < o; C++) ((g[C] = i[C]), (E[C] = GA(n)));
                  I = o;
                } else {
                  for (
                    r = new Array(o),
                  ...
                  for (l = I - 1, h = o - 1; l >= c && h >= c && g[l] === i[h]; l--, h--)
                    ((r[h] = E[l]), (s[h] = V[l]), e && (a[h] = e[l]));
                  for (A = new Map(), B = new Array(h + 1), C = h; C >= c; C--)
                    ((u = i[C]), (t = A.get(u)), (B[C] = void 0 === t ? -1 : t), A.set(u, C));
                  for (t = c; t <= l; t++)
                    ((u = g[t]),
                      (C = A.get(u)),
                      void 0 !== C && -1 !== C
                  ...
                  for (C = c; C < o; C++)
                    C in r
                      ? ((E[C] = r[C]), (V[C] = s[C]), e && ((e[C] = a[C]), e[C](C)))
                      : (E[C] = GA(n));
          ...
          () => {
            ...
            return (
              ...
              mA(() => {
                if (0 === i)
                  return (
                    0 !== t && (QB(I), (I = []), (E = []), (V = []), (t = 0), (e = [])),
                    Q.fallback &&
                      ((E = [BB]), (V[0] = GA((A) => ((I[0] = A), Q.fallback()))), (t = 1)),
                    V
                  );
                for (
                  E[0] === BB && (I[0](), (I = []), (E = []), (V = []), (t = 0)), g = 0;
                  g < i;
                  g++
                )
                  g < E.length && E[g] !== C[g]
                ...
                return ((t = e.length = I.length = i), (E = C.slice(0)), (V = V.slice(0, t)));
              })
            );
            function o(A) {
              I[g] = A;
  ...
  function aB(A, B, Q, g = {}) {
    ...
    return (
      GA((g) => {
        ((E = g), B === document ? A() : fB(B, A(), B.firstChild ? null : void 0, Q));
      }, g.owner),
      () => {
        (E(), (B.textContent = ""));
      }
  ...
  function cB(A, B, Q, g) {
    ...
    const V = () => {
        ...
        return ((B.innerHTML = A), Q ? B.content.firstChild.firstChild : B.content.firstChild);
      },
      I = B
  ...
  function wB(A, B, Q, g) {
    Array.isArray(Q) ? ((A[`$$${B}`] = Q[0]), (A[`$$${B}Data`] = Q[1])) : (A[`$$${B}`] = Q);
  }
  function DB(A, B, Q) {
    ...
    let E, V;
    for (V in ("string" == typeof Q && (g.cssText = Q = void 0), Q || (Q = {}), B || (B = {}), Q))
  ...
  function fB(A, B, Q, g) {
    if ((void 0 === Q || g || (g = []), "function" != typeof B)) return qB(A, B, g, Q);
    MA((g) => qB(A, B(), g, Q), g);
  }
  function yB(A) {
    let B = A.target;
    const Q = `$$${A.type}`,
      g = A.target,
      E = A.currentTarget,
      V = (B) => Object.defineProperty(A, "target", { configurable: !0, value: B }),
      I = () => {
        const g = B[Q];
        if (g && !B.disabled) {
          const E = B[`${Q}Data`];
          if ((void 0 !== E ? g.call(B, E, A) : g.call(B, A), A.cancelBubble)) return;
        }
        return (
          B.host &&
  ...
  function qB(A, B, Q, g, E) {
    ...
    const V = typeof B,
      I = void 0 !== g;
    if (((A = (I && Q[0] && Q[0].parentNode) || A), "string" === V || "number" === V)) {
      if ("number" === V && (B = B.toString()) === Q) return Q;
      if (I) {
        let E = Q[0];
        (E && 3 === E.nodeType ? E.data !== B && (E.data = B) : (E = document.createTextNode(B)),
          (Q = FB(A, Q, g, E)));
      } else Q = "" !== Q && "string" == typeof Q ? (A.firstChild.data = B) : (A.textContent = B);
              ...
              : (function (A, B, Q) {
                  ...
                  for (; I < E || e < V; )
                    if (B[I] !== Q[e]) {
                      for (; B[E - 1] === Q[V - 1]; ) (E--, V--);
                      if (E === I) {
                        const B = V < g ? (e ? Q[e - 1].nextSibling : Q[V - e]) : t;
                        for (; e < V; ) A.insertBefore(Q[e++], B);
                      } else if (V === e)
                        for (; I < E; ) ((C && C.has(B[I])) || B[I].remove(), I++);
                        ...
                        if (null != g)
                          if (e < g && g < V) {
                            let t,
                              i = I,
                              o = 1;
                            for (; ++i < E && i < V && null != (t = C.get(B[i])) && t === g + o; )
                              o++;
                            if (o > g - e) {
                              const E = B[I];
  ...
  function kB(A, B, Q, g) {
    ...
    for (let V = 0, I = B.length; V < I; V++) {
      ...
      if (null == e || !0 === e || !1 === e);
        ...
        if (g) {
          for (; "function" == typeof e; ) e = e();
          E = kB(A, Array.isArray(e) ? e : [e], Array.isArray(t) ? t : [t]) || E;
        } else (A.push(e), (E = !0));
      else {
        const B = String(e);
        t && 3 === t.nodeType && t.data === B ? A.push(t) : A.push(document.createTextNode(B));
      }
    }
    return E;
  }
    ...
    if (B.length) {
      ...
      for (let V = B.length - 1; V >= 0; V--) {
        ...
        if (E !== I) {
          ...
          g || V ? B && I.remove() : B ? A.replaceChild(E, I) : A.insertBefore(E, Q);
        } else g = !0;
      }
  ...
  function LB(A) {
    ...
    if (
      !B &&
      (Object.defineProperty(A, aA, { value: (B = new Proxy(A, bB)) }), !Array.isArray(A))
    ) {
      ...
      for (let E = 0, V = Q.length; E < V; E++) {
        const V = Q[E];
        g[V].get &&
          Object.defineProperty(A, V, { enumerable: g[V].enumerable, get: g[V].get.bind(B) });
      }
    }
    return B;
  }
  function mB(A) {
    ...
    return (
      null != A &&
      "object" == typeof A &&
      (A[aA] || !(B = Object.getPrototypeOf(A)) || B === Object.prototype || Array.isArray(A))
    );
  }
  function JB(A, B = new Set()) {
    let Q, g, E, V;
    if ((Q = null != A && A[GB])) return Q;
    if (!mB(A) || B.has(A)) return A;
    if (Array.isArray(A)) {
      Object.isFrozen(A) ? (A = A.slice(0)) : B.add(A);
      for (let Q = 0, V = A.length; Q < V; Q++) ((E = A[Q]), (g = JB(E, B)) !== E && (A[Q] = g));
    } else {
      Object.isFrozen(A) ? (A = Object.assign({}, A)) : B.add(A);
      const Q = Object.keys(A),
        I = Object.getOwnPropertyDescriptors(A);
      for (let e = 0, t = Q.length; e < t; e++)
        ((V = Q[e]), I[V].get || ((E = A[V]), (g = JB(E, B)) !== E && (A[V] = g)));
    }
    return A;
  }
  function SB(A, B) {
    let Q = A[B];
    return (Q || Object.defineProperty(A, B, { value: (Q = Object.create(null)) }), Q);
  }
  function vB(A, B, Q) {
    if (A[B]) return A[B];
  ...
  const bB = {
    get(A, B, Q) {
      ...
      if (!E) {
        ...
        !vA() ||
          ("function" == typeof V && !A.hasOwnProperty(B)) ||
          (Q && Q.get) ||
          (V = vB(g, B, V)());
      }
      return mB(V) ? LB(V) : V;
  ...
  function YB(A, B, Q, g = !1) {
    ...
    const E = A[B],
      V = A.length;
    void 0 === Q
      ? (delete A[B], A[MB] && A[MB][B] && void 0 !== E && A[MB][B].$())
      : ((A[B] = Q), A[MB] && A[MB][B] && void 0 === E && A[MB][B].$());
    let I,
      e = SB(A, NB);
    if (((I = vB(e, B, E)) && I.$(() => Q), Array.isArray(A) && A.length !== V)) {
  ...
  function xB(A, B, Q = []) {
    ...
    if (B.length > 1) {
      ...
      if (I && "function" === V) {
        for (let E = 0; E < A.length; E++) g(A[E], E) && xB(A, [E].concat(B), Q);
        return;
      }
      if (I && "object" === V) {
    ...
    ("function" == typeof V && ((V = V(E, Q)), V === E)) ||
      (void 0 === g && null == V) ||
      ((V = JB(V)), void 0 === g || (mB(E) && mB(V) && !Array.isArray(V)) ? KB(E, V) : YB(A, g, V));
  }
  function TB(...[A, B]) {
    const Q = JB(A || {}),
      g = Array.isArray(Q);
    return [
      ...
      function (...A) {
        LA(() => {
          g && 1 === A.length
            ? (function (A, B) {
                if (("function" == typeof B && (B = B(A)), (B = JB(B)), Array.isArray(B))) {
                  if (A === B) return;
                  let Q = 0,
                    g = B.length;
                  for (; Q < g; Q++) {
  ...
  function OB(A, B, Q, g, E) {
    ...
    if (Q !== HB && (!mB(A) || !mB(V) || I !== Array.isArray(V) || (E && A[E] !== V[E])))
    ...
    if (I) {
      if (A.length && V.length && (!g || (E && A[0] && null != A[0][E]))) {
        ...
        for (
          ...
          I < e && (V[I] === A[I] || (E && V[I] && A[I] && V[I][E] === A[I][E]));
          I++
        )
          OB(A[I], V, I, g, E);
        ...
        for (
          ...
          e >= I && t >= I && (V[e] === A[t] || (E && V[e] && A[t] && V[e][E] === A[t][E]));
          e--, t--
        )
          n[t] = V[e];
        if (I > t || I > e) {
        ...
        for (B = I; B <= e; B++)
          ((C = V[B]),
            (o = E && C ? C[E] : C),
            (Q = r.get(o)),
            void 0 !== Q && -1 !== Q && ((n[Q] = V[B]), (Q = i[Q]), r.set(o, Q)));
    ...
    for (let B = 0, Q = t.length; B < Q; B++) void 0 === A[t[B]] && YB(V, t[B], void 0);
  }
  function WB(A, B = {}) {
  ...
  function zB(A, B) {
    ...
    return (
      (s = (B) => {
        const Q = A();
        return mA(t) ? (t(), B) : (Q !== B && ((C = Q), LA(() => mA(() => r(B)))), Q);
      }),
      (a = B.appear ? void 0 : Q),
      HA(OA(s, a, !0, wA)),
      I
  ...
  var gQ = (A) => {
    const B = RA(() => {
      ...
      g = RA(() =>
        (function (A, B, Q, g) {
          let E = { "--offset": B, width: `${Q + 0.01}ch` };
      ...
      E = RA(() =>
        (function (A, B, Q, g) {
          ...
          (A.has("bold") || ((V = A.get("fg")), "number" == typeof V && V >= 8 && V <= 15)) &&
            (E += " ap-bright");
          var V;
      ...
      return (
        ...
        MA(
          (B) => {
            const Q = E(),
              V = g();
            return (Q !== B._v$ && uB(A, (B._v$ = Q)), (B._v$2 = DB(A, V, B._v$2)), B);
          },
            ...
            get each() {
              return (() => {
                if ("number" == typeof A.cursor) {
                  ...
                  let Q = 0,
                    g = 0;
                  for (; g < A.segments.length && Q + A.segments[g].w - 1 < A.cursor; ) {
                  ...
                  if (g < A.segments.length) {
                    ...
                    for (
                      e > 0 && B.push({ ...E, t: t.slice(0, e).join("") }),
                        ...
                        e < t.length - 1 &&
                          B.push({ ...E, t: t.slice(e + 1).join(""), x: Q + I + 1, w: E.w - V }),
                        g++;
                      g < A.segments.length;
                    ) {
              ...
              gB(
                ...
                (function (...A) {
                    ...
                    return new Proxy(
                      {
                        ...
                        has(B) {
                          for (let Q = A.length - 1; Q >= 0; Q--) if (B in IB(A[Q])) return !0;
                          return !1;
                        },
                        keys() {
                          const B = [];
                          for (let Q = 0; Q < A.length; Q++) B.push(...Object.keys(IB(A[Q])));
                          return [...new Set(B)];
                        },
                      },
                      VB,
                  ...
                  for (let A = V.length - 1; A >= 0; A--) {
                    const B = V[A],
                      Q = g[B];
                    Q && Q.get ? Object.defineProperty(E, B, Q) : (E[B] = Q ? Q.value : void 0);
                  }
                  return E;
                })(A),
              ),
  ...
  var fQ = (A) => dQ.cloneNode(!0);
  const yQ = cB('<span class="ap-button ap-playback-button" tabindex="0"></span>', 2),
    qQ = cB(
  ...
  var LQ = (A) => {
    const B = (A) => (B) => {
      ...
      Q = () => ("number" == typeof A.currentTime ? MQ(A.currentTime) : "--:--"),
      g = () => ("number" == typeof A.remainingTime ? "-" + MQ(A.remainingTime) : Q()),
      E = RA(() =>
        "number" == typeof A.duration ? A.markers.filter((B) => B[0] < A.duration) : [],
      ),
      V = (A) => {
      ...
      t = (function (A, B) {
        ...
        return function () {
          if (Q) {
            Q = !1;
            for (var g = arguments.length, E = new Array(g), V = 0; V < g; V++) E[V] = arguments[V];
            ...
            gB(oB, {
              ...
              get children() {
                ...
                return (
                      ...
                      children: (Q, g) =>
                        (() => {
                          ...
                          return (
                            ...
                            fB(I, () =>
                              ((A) => ("" === A[1] ? MQ(A[0]) : `${MQ(A[0])} - ${A[1]}`))(Q),
                            ),
                            MA(
                              (B) => {
                                const g = ((B) => (B[0] / A.duration) * 100 + "%")(Q),
                                  I = !!((B) =>
                                    "number" == typeof A.currentTime && B[0] <= A.currentTime)(Q);
                                return (
                                  g !== B._v$ && E.style.setProperty("left", (B._v$ = g)),
                                  I !== B._v$2 &&
                                    V.classList.toggle("ap-marker-past", (B._v$2 = I)),
                                  B
                                );
                              },
                              { _v$: void 0, _v$2: void 0 },
                  ...
                  MA((B) => DB(g, { transform: `scaleX(${A.progress || 0}` }, B)),
                  Q
                );
              },
            }),
  ...
  const mQ = cB('<div class="ap-overlay ap-overlay-error"><span>💥</span></div>', 4);
  var JQ = (A) => mQ.cloneNode(!0);
  const SQ = cB(
    '<div class="ap-overlay ap-overlay-loading"><span class="ap-loader"></span></div>',
    4,
  );
  var vQ = (A) => SQ.cloneNode(!0);
  const UQ = cB('<div class="ap-overlay ap-overlay-info"><span></span></div>', 4);
  var bQ = (A) =>
    (() => {
  ...
  const xQ = cB("<li><kbd>space</kbd> - pause / resume</li>", 4),
    TQ = cB("<li><kbd>←</kbd> / <kbd>→</kbd> - rewind / fast-forward by 5 seconds</li>", 6),
    HQ = cB(
      "<li><kbd>Shift</kbd> + <kbd>←</kbd> / <kbd>→</kbd> - rewind / fast-forward by 10%</li>",
      8,
    ),
    OQ = cB("<li><kbd>[</kbd> / <kbd>]</kbd> - jump to the previous / next marker</li>", 6),
    WQ = cB(
  ...
  var PQ = (A) => {
    ...
    (Q.addEventListener("ready", (A) => {
      let { isPausable: B, isSeekable: Q, poster: g } = A;
      (V({ isPausable: B, isSeekable: Q }), T(g), Y());
    }),
      Q.addEventListener("metadata", (A) => {
        let { cols: B, rows: Q, duration: g, theme: E, poster: V, markers: I, hasAudio: e } = A;
        LA(() => {
    ...
    const Z = async () => {
      ...
      z = () => {
        V("isFullscreen", document.fullscreenElement ?? document.webkitFullscreenElement);
      },
      X = () => {
        E.isFullscreen
          ? (document.exitFullscreen ?? document.webkitExitFullscreen ?? (() => {})).apply(document)
          : (J.requestFullscreen ?? J.webkitRequestFullscreen ?? (() => {})).apply(J);
      },
      _ = () => {
        y() ? q(!1) : (Q.pause(), q(!0));
      },
      P = (A) => {
        if (!(A.altKey || A.metaKey || A.ctrlKey)) {
          ...
          else if ("ArrowLeft" == A.key) A.shiftKey ? Q.seek("<<<") : Q.seek("<<");
          else if ("ArrowRight" == A.key) A.shiftKey ? Q.seek(">>>") : Q.seek(">>");
          else {
      ...
      eA = RA(() => {
        ...
        return "auto/" === B.slice(0, 5) ? { name: B.slice(5), colors: k() } : { name: B };
      }),
      tA = () => {
        H.then(() => Q.play());
      },
            ...
            (g) => {
              const E = !!(!0 === A.controls || ("auto" === A.controls && d())),
                ...
                I = (() => {
                  ...
                  const Q = j();
                  (void 0 !== Q.width && ((B.width = `${Q.width}px`), (B.height = `${Q.height}px`)),
  ...
  function $Q(A, B) {
    ...
    const g = (function (A, B) {
        ...
        const I = aB(() => ((V = gB(CQ, { cols: Q, rows: g, lineHeight: B, lines: [] })), V), E),
          e = {
      ...
      const E = g.logger ?? new Q(),
        ...
        { el: I, dispose: e } = $Q(
          ...
          (function (A) {
            ...
            return ((Q.autoPlay ??= Q.autoplay), (Q.controls ??= "auto"), { ...Q, ...B });
          })(g, { logger: E }),
        ),
        t = V.init(),
        C = {
